...
import { SlideAnimator } from './slides.animator';
import { SlideEventEnd, SlideEventStart, SlideEvent } from './slides.event';
import { SlideServiceConfig } from './slides.service.config';
